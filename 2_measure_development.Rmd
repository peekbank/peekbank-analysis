...
Let's start by thinking about what the basic curve is and how to get out various measures. This curve is just averaging across every single adminstration timepoint - unweighted. The idea is just to give a sense for what the average probability function is that we're trying to measure. 
